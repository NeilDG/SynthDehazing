...
from trainers.latent_trainers import latent_trainer_128
import constants
...
def main(argv):
    ...
    trainer = latent_trainer_128.LatentTrainer(constants.DEHAZER_VERSION, constants.ITERATION, device, opts.g_lr, opts.d_lr)
    ...
    train_loader = dataset_loader.load_latent_dataset(constants.DATASET_VEMON_PATH_PATCH_128, constants.batch_size, opts.img_to_load)
