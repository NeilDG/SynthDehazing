...
class CycleGANTrainer:
    ...
    def __init__(self, gpu_device, batch_size, g_lr, d_lr, num_blocks, net_config, use_bce):
    ...
    def visdom_report(self, iteration, dirty_tensor, clean_tensor, test_dirty_tensor, test_clean_tensor):
        ...
        self.visdom_reporter.plot_image(dirty_tensor, "Training Dirty images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(clean_tensor, "Training Clean images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(clean_like, "Training Clean-like images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(test_dirty_tensor, "Test Dirty images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(test_dirty_like, "Test Dirty-like images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(test_clean_tensor, "Test Clean images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(test_clean_like, "Test Clean-like images - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
    ...
    def visdom_infer(self, test_dirty_tensor, caption_dirty, caption_clean):
        ...
        self.visdom_reporter.plot_image(test_dirty_tensor, caption_dirty + " - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
        self.visdom_reporter.plot_image(test_clean_like, caption_clean + " - " + str(constants.STYLE_TRANSFER_VERSION) + str(constants.ITERATION))
