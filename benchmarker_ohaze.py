...
def main():
    ...
    produce_ohaze("transmission_albedo_estimator_v1.15_1", "airlight_estimator_v1.15_1", True)
    benchmark_ohaze("transmission_albedo_estimator_v1.15_1", "airlight_estimator_v1.15_1")
