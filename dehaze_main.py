...
def update_config(opts):
    ...
    constants.DEHAZER_VERSION = opts.version_name
...
def main(argv):
    ...
    early_stopper_l1 = early_stopper.EarlyStopper(20, early_stopper.EarlyStopperMethod.L1_TYPE, 2000)
    ...
    if(opts.load_previous):
        ...
        print("Loaded checkpt: %s Current epoch: %d" % (constants.DEHAZER_CHECKPATH, start_epoch))
        print("===================================================")

    # Create the dataloader
    train_loader = dataset_loader.load_dehazing_dataset(constants.DATASET_CLEAN_PATH_COMPLETE_STYLED_3, constants.DATASET_DEPTH_PATH_COMPLETE_3, opts, True)
