...
def main(argv):
    ...
    gt = albedo_trainer.AlbedoTrainer(device, opts.g_lr, opts.d_lr, opts.num_blocks)
    gt.update_penalties(opts.adv_weight, opts.likeness_weight, opts.psnr_loss_weight, opts.use_psnr, opts.comments)
    start_epoch = 0
    iteration = 0
